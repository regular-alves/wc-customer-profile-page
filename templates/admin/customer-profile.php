...
<div class="wrap wccp-profile-wrap">
	...
	<div class="wccp-map">
		<iframe
			src="<?php echo esc_url( 'https://maps.google.com/maps?q=' . rawurlencode( $wccp_billing_address ) . '&output=embed' ); ?>"
			loading="lazy"
			referrerpolicy="no-referrer-when-downgrade"
			title="<?php esc_attr_e( 'Customer location', 'customer-profile-page-for-woocommerce' ); ?>"
		></iframe>
	</div>
	<?php endif; ?>
